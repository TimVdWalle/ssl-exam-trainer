...
return [
    ...
    */
    ...
    'alpha_dash'           => ':Attribute mag alleen letters, nummers, nl strepen bevatten.',
    'alpha_num'            => ':Attribute mag alleen letters nl nummers bevatten.',
    ...
    'between'              => [
        'numeric' => ':Attribute moet tussen :min nl :max liggen.',
        'file'    => ':Attribute moet tussen :min nl :max kilobytes zijn.',
        'string'  => ':Attribute moet tussen :min nl :max karakters lang zijn.',
        'array'   => ':Attribute moet tussen :min nl :max items bevatten.',
    ],
    ...
    'different'            => ':Attribute nl :other dienen verschillend te zijn.',
    'digits'               => ':Attribute moet :digits cijfers zijn.',
    'digits_between'       => ':Attribute moet tussen :min nl :max cijfers zijn.',
    ...
    'password'             => [
        ...
        'mixed'   => ':Attribute moet minstens één hoofdletter nl één kleine letter bevatten.',
    ...
    'same'                 => ':Attribute nl :other moeten hetzelfde zijn.',
    'size'                 => [
